// Lista Oficial e Padronizada das Regiões Administrativas (RAs) do Distrito Federal em Ordem Alfabética
export const RA_LIST = [
  ...
  { name: 'Estrutural', lat: -15.779, lng: -47.994, prefix: 'STR' },
...
const RA_NORMALIZATION_MAP = {
  ...
  'park way': 'Park Way',
  'park way ': 'Park Way',
  'scia (setor complementar de industria e abastamento) e estrutural': 'Estrutural',
  'scia (setor complementar de industria e abastecimento) e estrutural': 'Estrutural',
  'scia (setor de complementacao de industria e abastecimento)': 'Estrutural',
  'scia/estrutural': 'Estrutural',
  'scia / estrutural': 'Estrutural',
  'estrutural': 'Estrutural',
  'cidade estrutural': 'Estrutural',
  'scia': 'Estrutural',
  'setor complementar de industria e abastecimento': 'Estrutural',
